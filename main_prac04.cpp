...
void display(void)
{
	...
	model = glm::scale(model, glm::vec3(0.2, 0.2, 1)); //HACEMOS UN "MODELO" ESCALADO CON MEDIDAS 5 * 1 * 3 UNIDADES
	...
	model = glm::scale(model, glm::vec3(2.5, 1.25, 1)); //HACEMOS UN "MODELO" ESCALADO CON MEDIDAS 5 * 1 * 3 UNIDADES
	projectionShader.setMat4("model", model); //LE PASAMOS LOS DATOS DEL MODELO AL SHADER
	projectionShader.setVec3("aColor", glm::vec3(1.0f, 1.4f, 1.5f)); //AQUI SE GENERA EL VECTOR EN RGB PARA PINTAR NUESTRO CUBO UNITARIO
	glDrawArrays(GL_QUADS, 0, 24); //DIBUJAMOS EL CUBO ESCALADO
	...
	//brazo derecho
	model = glm::translate(model = glm::mat4(1.0f), glm::vec3(3, -1.25, 0));
	...
	//Cinturon
	model = glm::translate(model = glm::mat4(1.0f), glm::vec3(0, -5.25, 0));
	...
	//antebrazo derecho
	model = glm::translate(model = glm::mat4(1.0f), glm::vec3(4.5, -2.25, 0));
	...
	//antebrazo izqueierdo 
	model = glm::translate(model = glm::mat4(1.0f), glm::vec3(-4.5, -2.25, 0));
	model = glm::scale(model, glm::vec3(1, 3, 1));
	projectionShader.setMat4("model", model); //LE PASAMOS LOS DATOS DEL MODELO AL SHADER
	projectionShader.setVec3("aColor", glm::vec3(2.0f, 0.0f, 0.0f)); //AQUI SE GENERA EL VECTOR EN RGB PARA PINTAR NUESTRO CUBO UNITARIO
	glDrawArrays(GL_QUADS, 0, 24); //DIBUJAMOS EL CUBO ESCALADO

	//pie derecho 
	model = glm::translate(model = glm::mat4(1.0f), glm::vec3(1.5, -6.75, 0));
	...
	//Zapato derecho
	model = glm::translate(model = glm::mat4(1.0f), glm::vec3(2.0, -8.25, 0));
	model = glm::scale(model, glm::vec3(2, 1, 1));
	projectionShader.setMat4("model", model); //LE PASAMOS LOS DATOS DEL MODELO AL SHADER
