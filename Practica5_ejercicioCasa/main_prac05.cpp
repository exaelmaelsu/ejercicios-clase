...
//bicep
  ...
  //antebrazo
	...
	projectionShader.setMat4("model", model);
	projectionShader.setVec3("aColor", glm::vec3(1, 0.0, .9));
	glDrawArrays(GL_QUADS, 0, 24);
	model = modelTemp2;
	...
	projectionShader.setMat4("model", model);
	projectionShader.setVec3("aColor", glm::vec3(1, 0.4, 1.0));
	glDrawArrays(GL_QUADS, 0, 24);
	model = modelTemp;
	//inice2
	...
	model = glm::scale(model, glm::vec3(0.3, 0.25, 0.3));//escalas
	projectionShader.setMat4("model", model);
	projectionShader.setVec3("aColor", glm::vec3(1, 0.0, .2));
	glDrawArrays(GL_QUADS, 0, 24);
	model = modelTemp;
	//indic3
	model = glm::translate(model, glm::vec3(0.15, 0, 0));//pivote articulacion
	...
	model = glm::scale(model, glm::vec3(0.3, 0.25, 0.3));//escalas
	projectionShader.setMat4("model", model);
	projectionShader.setVec3("aColor", glm::vec3(1, 0.0, 1.0));
	glDrawArrays(GL_QUADS, 0, 24);
	model = modelTemp2;
	...
	model = glm::scale(model, glm::vec3(0.4, 0.25, 0.3));//escalas
	projectionShader.setMat4("model", model);
	projectionShader.setVec3("aColor", glm::vec3(1.0, 0.9, 1));
	glDrawArrays(GL_QUADS, 0, 24);
	model = modelTemp;
	//med3
	model = glm::translate(model, glm::vec3(0.15, 0, 0));//pivote articulacion
	...
	model = glm::scale(model, glm::vec3(0.4, 0.25, 0.3));//escalas
	projectionShader.setMat4("model", model);
	projectionShader.setVec3("aColor", glm::vec3(1, 0, 0.3));
	glDrawArrays(GL_QUADS, 0, 24);
	model = modelTemp2;
	...
	model = glm::scale(model, glm::vec3(0.3, 0.25, 0.3));//escalas
	projectionShader.setMat4("model", model);
	projectionShader.setVec3("aColor", glm::vec3(1, 0.9, 1.0));
	glDrawArrays(GL_QUADS, 0, 24);
	model = modelTemp;
	//anu3
	model = glm::translate(model, glm::vec3(0.15, 0, 0));//pivote articulacion
	...
	projectionShader.setMat4("model", model);
	projectionShader.setVec3("aColor", glm::vec3(.4, 0, .7));
	glDrawArrays(GL_QUADS, 0, 24);
	model = modelTemp;
	//meñ2
	...
	model = glm::scale(model, glm::vec3(0.2, 0.25, 0.3));//escalas
	projectionShader.setMat4("model", model);
	projectionShader.setVec3("aColor", glm::vec3(0, 0.9, .4));
	glDrawArrays(GL_QUADS, 0, 24);
	model = modelTemp;
	//meñ3
	model = glm::translate(model, glm::vec3(0.1, 0, 0));//pivote articulacion
	...
	model = glm::scale(model, glm::vec3(0.2, 0.25, 0.3));//escalas
	projectionShader.setMat4("model", model);
	projectionShader.setVec3("aColor", glm::vec3(0, 0.2, .6));
	glDrawArrays(GL_QUADS, 0, 24);
	model = modelTemp;
