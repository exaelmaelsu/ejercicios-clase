...
void display(void)
{
	...
	//Núcleo
	//model = glm::rotate(model, glm::radians(nucleo), glm::vec3(0.0f, 1.0f, 0.0f)); //El nucleo no gira
	model = glm::scale(model, glm::vec3(1.0f, 1.0f, 1.0f));
	projectionShader.setMat4("model", model);
	projectionShader.setVec3("color", glm::vec3(1.0f, 1.0f, 1.0f));
	...
	//Electrón1
	model = glm::rotate(model, glm::radians(electron), glm::vec3(-1.0f, 0.0f, 0.0f)); //traslacion
	...
	//Electrón2
	model = glm::rotate(model, glm::radians(electron), glm::vec3(0.0f, 1.0f, 0.0f)); //traslacion
	model = glm::translate(model, glm::vec3(4, 0, 0));
	model = glm::scale(model, glm::vec3(0.2f, 0.2f, 0.2f));
	projectionShader.setMat4("model", model);
	projectionShader.setVec3("color", glm::vec3(0.0f, 1.0f, 0.0f));
	sphere_draw();
	model = glm::mat4(1.0f); //Inicializamos la matriz para que ignora la escala y rotación definidas anteriormente

	//Electrón3
	model = glm::rotate(model, glm::radians(electron), glm::vec3(0.0f, 0.0f, 1.0f)); //traslacion
	model = glm::translate(model, glm::vec3(4, 0, 0));
	model = glm::scale(model, glm::vec3(0.2f, 0.2f, 0.2f));
	projectionShader.setMat4("model", model);
	...
	//Electrón4
	model = glm::rotate(model, glm::radians(electron), glm::vec3(-1.0f, 0.0f, 1.0f)); //traslacion
	model = glm::translate(model, glm::vec3(0, 4, 0));
	model = glm::scale(model, glm::vec3(0.2f, 0.2f, 0.2f));
	projectionShader.setMat4("model", model);
	projectionShader.setVec3("color", glm::vec3(1.0f, 0.0f, 1.0f));
	sphere_draw();
	model = glm::mat4(1.0f); //Inicializamos la matriz para que ignora la escala y rotación definidas anteriormente
	...
	model = glm::scale(model, glm::vec3(0.2f, 0.2f, 0.2f));
	projectionShader.setMat4("model", model);
	projectionShader.setVec3("color", glm::vec3(0.0f, 1.0f, 1.0f));
	sphere_draw();
	model = glm::mat4(1.0f); //Inicializamos la matriz para que ignora la escala y rotación definidas anteriormente
